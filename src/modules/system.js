import {networkStats, networkConnections, mem} from "systeminformation"
import os from "os"
...
export const processPlatform = async () => {
    ...
    setTimeout( processPlatform, 10000 )
}

export const processCpuLoad = async () => {
